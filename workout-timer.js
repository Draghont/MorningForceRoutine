  ...
  static getEmbeddedTiming() {
    return {
      ...
      exercises: [
        ...
        { n: 9, id: "mil_press_bw", block: "warmup_standing", work_s: 30, setup_s: 10 },
        { n: 10, id: "rev_fly_bw", block: "warmup_standing", work_s: 30, setup_s: 0 },
        { n: 11, id: "wall_pushup", block: "warmup_standing", work_s: 30, setup_s: 10 },
        ...
        { n: 15, id: "plank_front", block: "warmup_floor", work_s: 30, setup_s: 5 },
        { n: 16, id: "russian_twist_bw", block: "warmup_floor", work_s: 30, setup_s: 5 },
        { n: 17, id: "banded_psoas_march", block: "warmup_floor", work_s: 30, setup_s: 15 },
        { n: 18, id: "glute_bridge_bi", block: "warmup_floor", work_s: 30, setup_s: 3 },
        { n: 19, id: "sliding_curl_bi", block: "warmup_floor", work_s: 30, setup_s: 10 },
        ...
        { n: 22, id: "rev_fly_load", block: "strength_standing", work_s: 30, setup_s: 10 },
        ...
        { n: 27, id: "incline_pushup", block: "strength_floor", work_s: 30, setup_s: 5 },
        ...
        { n: 40, id: "worlds_greatest_stretch", block: "stretching", work_s: 45, setup_s: 2 }
      ]
    };
  }
